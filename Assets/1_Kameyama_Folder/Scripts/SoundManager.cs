/*=========================================
 * 使い方として、BGMとSEのenumにそれぞれ追加してください
 * その後、SoundManagerのInspector上で対応する場所に音を入れてください
 * 
...
public class SoundManager : MonoBehaviour
{
    ...
    private Coroutine fadeCoroutine;        // フェード用コルーチン
    private int? currentBGMIndex = null;    // 現在再生中のBGMインデックス
